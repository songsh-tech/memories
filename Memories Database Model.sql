...
CREATE TABLE IF NOT EXISTS `memories`.`user` (
  ...
  `userpassword` VARCHAR(255) NOT NULL COMMENT '사용자 비밀번호',
...
-- -----------------------------------------------------
-- Table `memories`.`user_1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `memories`.`user_1` (
...
-- -----------------------------------------------------
-- Table `memories`.`table1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `memories`.`table1` (
  `user_id` INT NOT NULL,
  `user_password` VARCHAR(45) NULL,
  `joion_type` VARCHAR(6) NULL,
...
CREATE TABLE IF NOT EXISTS `memories`.`concentration_test` (
  ...
  PRIMARY KEY (`user_id`, `sequence`),
  CONSTRAINT `concentration-test-user`
    FOREIGN KEY (`user_id`)
    REFERENCES `memories`.`user` (`user_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Placeholder table for view `memories`.`view1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `memories`.`view1` (`id` INT);

-- -----------------------------------------------------
-- View `memories`.`view1`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `memories`.`view1`;
USE `memories`;

CREATE USER 'developer' IDENTIFIED BY 'qwer1234';

GRANT ALL ON `memories`.* TO 'developer';
